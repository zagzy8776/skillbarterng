        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-2xl p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-green-800 dark:text-green-200">Secure Escrow Protection</h3>
            </div>
          ...
          {userTrades.length > 0 && (
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-6">My Active Trades</h2>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {userTrades.filter(trade => trade.status !== 'completed').map((trade) => (
                  <div key={trade.id} className="bg-gradient-to-br from-orange-50 to-amber-100 dark:from-orange-900/20 dark:to-amber-900/20 rounded-xl p-6 border border-orange-200 dark:border-orange-800 shadow-sm">
